...
delta_x = np.random.normal(0,1,(2,n))                               #Random positions are under a normal distribution (mean=0 : standard deviation=1).
                                                                    #Array of (2,n) being n the number of steps introduced.
